...
Статистична служба Європейського союзу, що займається збором статистичної інформації по країнах-членах ЄС і гармонізацією статистичних методів, які використовуються цими країнами. Має не дружній користувачу інтерфейс, але містить багато точної та актуальної інформації.
