...
Адміністратори є відповідальними за завантаження даних до системи і також мають можливість видаляти дані. Вони також мають можливість надавати користувачам права редактора.  
